package com.example.gercekzamanliaractakip.ui.home;
...
import com.example.gercekzamanliaractakip.Common;
import com.example.gercekzamanliaractakip.R;
import com.example.gercekzamanliaractakip.databinding.FragmentHomeBinding;
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                try {
                    ...
                    driversLocationRef = FirebaseDatabase.getInstance().getReference(Common.DRIVERS_LOCATİON_REFERENCES)
                            .child(cityName);
                    ...
                    geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(),
                            ...
                            (key, error) -> {
                                if (error != null)
                                    ...
                                    Snackbar.make(mapFragment.getView(), "Çevrimiçisiniz", Snackbar.LENGTH_LONG)
                                            .show();
